...
fetch(`http://localhost:3000/medico/traerDatosIncativos/`)
  .then((res) => res.json())
  .then((Programadas) => {
...
password:pass
        ...
        Swal.fire({
            ...
            window.location.assign("http://127.0.0.1:5500/cliente/administrador/administrarDoctoresInactivos.html");
        });
    } catch (error) {
