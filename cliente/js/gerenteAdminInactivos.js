...
fetch(`http://localhost:3000/Funcionario/traerFuncionarioAdminGerenteInactivos`)
  .then((res) => res.json())
  .then((Programadas) => {
...
if (!validarCorreo(email)) {
    ...
    try {
        ...
        Swal.fire({
            ...
            window.location.assign("http://127.0.0.1:5500/cliente/Gerente/administrarUsuariosInactivos.html");
        });
    } catch (error) {
